    ...
    <StaffLayout>
      <div className="w-full max-w-7xl mx-auto px-4 py-6 space-y-6 sm:px-6 lg:px-8">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          {/* OVERVIEW TAB: wrap all the existing main content that is not specifically costs-only */}
          <TabsContent value="overview" className="space-y-6 mt-4">
            {/* Everything that previously sat directly under the header goes here,
                EXCEPT any dedicated cost summary sections you want in the Costs tab. */}
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-4">
                <Button
                  variant="ghost"
          ...
          {/* BULK TAB: simple placeholder ready for future bulk project tools */}
          <TabsContent value="bulk" className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                <CardTitle>Bulk project context</CardTitle>
                <CardDescription>
                  This project was created from a bulk upload. Tools for reviewing
                  and reconciling bulk data for this specific project will appear here.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  No bulk-specific tools are configured yet for this project view.
                </p>
              </CardContent>
            </Card>
          </TabsContent>

          {/* COSTS TAB: move/duplicate the cost-related components here */}
          <TabsContent value="costs" className="space-y-4 mt-4">
            <ProjectCostSummary items={costAdvice} schemeLabel={schemeLabel} />
          </TabsContent>

          {/* APPORTION TAB: placeholder for apportionment tools */}
          <TabsContent value="apportion" className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                <CardTitle>Apportionment</CardTitle>
                <CardDescription>
                  Allocate costs and effort between qualifying and non-qualifying
                  activities for this project.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Apportionment tools have not been configured yet. This area is
                  reserved for future calculators and allocation tables.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
