...
import {
  buildClaimCritiqueReport,
  type ClaimCritiqueInput,
  type ClaimCritiqueResult,
  type ClaimCritiqueSectionAnalysis,
} from "@/lib/pdf/claimCritiqueReport";
...
export default function StaffClaimCritiquePage() {
  ...
  return (
    <StaffLayout title="AI Claim Critique">
      <SEO
