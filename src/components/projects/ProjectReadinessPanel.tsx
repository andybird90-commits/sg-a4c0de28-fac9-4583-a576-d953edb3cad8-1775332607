...
export const ProjectReadinessPanel: FC<ProjectReadinessPanelProps> = ({
  ...
  return (
    <Card className="bg-slate-950/60 border-slate-800">
      <CardHeader className="pb-4" style={{ backgroundColor: "#f3f4f6" }}>
        <div className="flex items-start justify-between gap-2">
          ...
          <div className="flex flex-col items-end text-right">
            <span className="text-xs text-slate-400" style={{ color: "#1a1a1a" }}>Overall</span>
            <span className="text-lg font-semibold text-slate-50 leading-none" style={{ color: "#1a1a1a" }}>
              {overallScore}/5
            </span>
            ...
            <div className="mt-1 flex items-center gap-1 text-[10px] text-slate-400">
                <Link2 className="h-3 w-3" style={{ backgroundColor: "#00000000" }} />
                <span style={{ color: "#1a1a1a" }}>Linked to RD Companion</span>
              </div>
            }
            {onSync &&
            <button
      ...
      <CardContent className="pt-0 space-y-4" style={{ backgroundColor: "#f3f4f6" }}>
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {scores.map((score) =>
          <div
            key={score.label}
            className="rounded-lg border border-slate-800 bg-slate-950/60 p-3" style={{ backgroundColor: "rgba(15, 29, 45, 0.6)" }}>
              ...
              <p className="mt-2 text-[11px] leading-snug text-slate-400" style={{ color: "#ffffff" }}>
                {score.description}
              </p>
            </div>
          )}
