  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1 mr-2">
                <img src="/rd_tax_white_wording.png" alt="RD TAX" className="h-8 sm:h-10 w-auto flex-shrink-0" />
              </div>
        ...
        {/* Hero */}
        <section className="relative pt-24 sm:pt-32 pb-12 sm:pb-20 overflow-hidden bg-background">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                ...
                <div className="text-center lg:text-left order-1 lg:order-2">
                  <Badge className="mb-4 sm:mb-6 bg-orange-500/10 text-orange-600 border-orange-500/40 px-3 sm:px-4 lg:px-6 py-1 sm:py-1.5 lg:py-2 text-xs sm:text-sm font-medium inline-flex items-center">
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground mb-6 sm:mb-8 lg:mb-10 leading-relaxed">
                    RD Companion helps you capture, organize, and submit R&D tax evidence on the go.
                    <span className="font-semibold text-foreground"> Never miss a claimable moment again.</span>
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start mb-8 sm:mb-12">
                    <Button
                      ...
                      variant="outline"
                      onClick={() => router.push("/auth/login")}
                      className="border-2 border-border text-primary hover:bg-muted text-sm sm:text-base lg:text-lg px-5 sm:px-6 lg:px-10 py-4 sm:py-5 lg:py-7 rounded-xl sm:rounded-2xl transition-all w-full sm:w-auto"
                    >
                      Log In
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4 max-w-lg mx-auto lg:mx-0">
                    {stats.map((stat, index) => (
                      <div
                        key={index}
                        className="rounded-lg sm:rounded-xl lg:rounded-2xl p-2.5 sm:p-3 lg:p-4 border border-border bg-card"
                      >
                        <div className="flex justify-center lg:justify-start mb-1 sm:mb-2">
                          <stat.icon className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-orange-500" />
                        </div>
                        <div className="text-xl sm:text-2xl lg:text-3xl font-black mb-0.5 sm:mb-1 truncate">
                          {stat.value}
                        </div>
                        <div className="text-2xs sm:text-xs text-muted-foreground font-medium leading-tight">
                          {stat.label}
                        </div>
                      </div>
                    ))}
        ...
        <section className="py-12 sm:py-16 lg:py-24 bg-background">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center mb-10 sm:mb-12 lg:mb-16">
              <Badge className="mb-3 sm:mb-4 bg-orange-500/10 text-orange-600 border-orange-500/40 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm">
                FEATURES
              </Badge>
        ...
        {/* How it works */}
        <section className="py-12 sm:py-16 lg:py-24 bg-muted/60">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center mb-10 sm:mb-12 lg:mb-16">
              <Badge className="mb-3 sm:mb-4 bg-orange-500/10 text-orange-600 border-orange-500/40 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm">
                HOW IT WORKS
              ...
              {steps.map((step, index) => (
                <div key={index} className="relative">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-3xl sm:text-4xl lg:text-6xl font-black text-foreground mb-2 sm:mb-3 lg:mb-4 text-center">
                      {step.number}
                    </div>
                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground mb-2 sm:mb-3 text-center">
                      {step.title}
                    </h3>
                    <p className="text-xs sm:text-sm lg:text-base text-muted-foreground leading-relaxed text-center px-2">
                      {step.description}
                    </p>
                  </div>
                </div>
        ...
        <section className="py-12 sm:py-16 lg:py-24 bg-background relative overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-foreground mb-4 sm:mb-6 px-2 leading-tight">
              Ready to Transform Your
              <br />
              R&D Evidence Collection?
            </h2>
            <p className="text-sm sm:text-base lg:text-xl text-muted-foreground mb-6 sm:mb-8 lg:mb-10 max-w-2xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 max-w-2xl mx-auto">
              ...
              <Button
                ...
                variant="outline"
                onClick={() => router.push("/auth/login")}
                className="border-2 border-border text-foreground hover:bg-muted text-sm sm:text-base lg:text-lg px-5 sm:px-6 lg:px-10 py-4 sm:py-5 lg:py-7 rounded-xl sm:rounded-2xl transition-all w-full sm:w-auto"
              >
